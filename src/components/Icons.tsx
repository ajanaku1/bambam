...
export function ChevronDown({ size = 20, ...props }: IconProps) {
  return (
...
export function ChevronUp({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" {...props}>
      <path d="M10 16V4M14 8l-4-4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function Menu({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" {...props}>
      <path d="M2 6H18M2 14H18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function Dot({ size = 8, ...props }: IconProps) {
  return (
