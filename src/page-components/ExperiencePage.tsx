...
export default function ExperiencePage({ isActive }: ExperiencePageProps) {
  return (
    <section className="h-screen flex items-start justify-center px-4 sm:px-6 overflow-y-auto overflow-x-hidden pt-16 sm:pt-20 pb-20 sm:pb-12">
      <div className="max-w-3xl mx-auto w-full">
        ...
        >
          <p className="font-mono text-xs sm:text-sm text-accent mb-3 sm:mb-4">Experience</p>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-3 sm:mb-4">
            Where I&apos;ve worked.
          </h2>
          <p className="text-muted leading-relaxed mb-8 sm:mb-12 text-sm sm:text-base">
        ...
        <div className="space-y-12">
          {experiences.map((group, groupIndex) => (
            <motion.div
              ...
              animate={isActive ? "animate" : "initial"}
              transition={{
                ...pageTransitionUp.transition,
                delay: 0.08 * (groupIndex + 1),
              }}
            >
              <p className="font-mono text-[10px] sm:text-xs text-accent tracking-wide mb-4 sm:mb-6 uppercase">
                {group.category}
              </p>
              ...
              {group.items.map((item) => (
                ...
                >
                  ...
                  <div className="pb-2">
                    ...
                    <p className="text-xs sm:text-sm text-accent/80 mb-2 sm:mb-3">
                      {item.company}
                    </p>
